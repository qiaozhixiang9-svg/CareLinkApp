...
public class ScheduleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        topTip.setText("像日历软件一样查看每天安排，也可以自己添加日程");
        topTip.setTextSize(FontScaleHelper.secondary(requireContext()));
        topTip.setPadding(24, 20, 24, 20);
        ...
        line1.setPadding(0, 16, 0, 8);
        line1.setBackgroundColor(0xFFFFF3E0);

        LinearLayout rowTop = new LinearLayout(requireContext());
        rowTop.setOrientation(LinearLayout.HORIZONTAL);
        LinearLayout rowBottom = new LinearLayout(requireContext());
        ...
        prevYear.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
        nextYear.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
        prevMonth.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
        nextMonth.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));

        rowTop.addView(prevYear);
        rowTop.addView(nextYear);
        rowBottom.addView(prevMonth);
        rowBottom.addView(nextMonth);
        line1.addView(rowTop);
        line1.addView(rowBottom);
        root.addView(line1);
        ...
        monthTitle.setPadding(0, 8, 0, 12);
        monthTitle.setBackgroundColor(0xFFFFF8E1);
        ...
        sectionTitle.setTextSize(FontScaleHelper.sectionTitle(requireContext()));
        sectionTitle.setPadding(20, 20, 20, 12);
        sectionTitle.setBackgroundColor(0xFFFFE0B2);
        ...
        btnPerpetual.setTextSize(FontScaleHelper.body(requireContext()));
        btnPerpetual.setOnClickListener(v -> startActivity(new Intent(requireContext(), com.carelink.app.ui.calendar.PerpetualCalendarActivity.class)));
    ...
    private TextView createHeaderButton(String text) {
        ...
        tv.setText(text);
        tv.setTextSize(FontScaleHelper.secondary(requireContext()));
